...
typedef enum {
  ...
  TOKEN_COMMA, TOKEN_DOT, TOKEN_DOT_DOT_DOT, 
  ...
  TOKEN_AT, TOKEN_PLUS_EQUAL, TOKEN_MINUS_EQUAL,
  TOKEN_SLASH_EQUAL, TOKEN_STAR_EQUAL,
  TOKEN_POWER_EQUAL, TOKEN_MODULO_EQUAL,
  TOKEN_SHOWEL_L_EQUAL, TOKEN_SHOWEL_R_EQUAL,
  TOKEN_AMP_EQUAL, TOKEN_PIPE_EQUAL,
  TOKEN_CARRET_EQUAL,
  ...
  TOKEN_DEFAULT, TOKEN_SWITCH, TOKEN_CONST,
  ...
  TOKEN_STATIC, TOKEN_ASSERT, TOKEN_ENUM, TOKEN_DO,
  TOKEN_GET, TOKEN_SET, TOKEN_YIELD, TOKEN_FROM,
  TOKEN_INSTANCEOF, TOKEN_ASYNC, TOKEN_AWAIT,
  TOKEN_ABSTRACT,
